          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">FORM EDIT KOTA</h4>
                </div>
              </div>
            </div>
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  @foreach ($kota as $p)
                  <form class="form-sample" action="{{url ('/kota/update')}}" method="post">
                    {{csrf_field()}}
                    <p class="card-description">
                      Info Kota
                    </p>
                    <input type="hidden" name="id_kota" value="{{ $p->id }}"> 
                    <br/>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nama_kota" value="{{$p->nama_kota}}" class="form-control" />
