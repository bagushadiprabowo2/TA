        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">DAFTAR WISATA</h4>
                </div>
                <div>
                    <a href="wisata/tambah" class="btn btn-primary">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">WISATA</p>
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        @foreach($wisata as $no=>$p)
                      <tr>
                        <td>{{ ++$no }}</td>
                        <td>{{ $p->nama_kota }}</td>
                        <td>{{ $p->nama_wisata }}</td>
                        <td>
                          <a class="btn btn-primary" href="wisata/edit/{{ $p->id_wisata }}">Edit</a>
                          <a class="btn btn-danger" href="wisata/hapus/{{ $p->id_wisata }}">Hapus</a>
                        </td>
                      </tr>
                      @endforeach
                        </td>
