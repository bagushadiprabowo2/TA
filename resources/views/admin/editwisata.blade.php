          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">FORM EDIT WISATA</h4>
                </div>
              </div>
            </div>
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  @foreach ($wisata as $p)
                  <form class="form-sample" action="{{url ('/wisata/update')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select data-placeholder="pilih pengguna" name="id_kota" id="select" class="form-control">
                              <option value=""> pilih kota </option>
                              @foreach($kota as $k)
                              <option value="{{$k->id}}" {{ $p->id_kota == $k->id ? 'selected' : '' }}>{{$k->nama_kota}}</option>
                              @endforeach
                               </select>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="nama_wisata" value="{{$p->nama_wisata}}" class="form-control" />
                          </div>
                        </div>
                      </div>
