          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">FORM EDIT PAKET</h4>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  @foreach($paket as $p)
                  <form class="form-sample" action="{{url ('usaha/update_paket')}}" method="post">
                       {{csrf_field()}}
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select data-placeholder="pilih usaha" name="id_usaha" id="select" class="form-control">
                              <option value=""> pilih usaha </option>
                              @foreach($usaha as $k)
                              <option value="{{$k->id_usaha}}" {{ $p->id_usaha == $k->id_usaha ? 'selected' : '' }}>{{$k->nama_usaha}}</option>
                              @endforeach
                               </select>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama_paket" value="{{$p->nama_paket}}">
                          </div>
                        </div>
                      </div>
                    </div>
