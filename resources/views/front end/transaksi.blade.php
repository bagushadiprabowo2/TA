			...
			<div class="container">
				<div class="inner-sec-shop pt-lg-4 pt-3">
					<div class="row">
							...
							<div class="col-lg-4 single-right-left">
									<div class="grid images_3_of_2">
										<div class="flexslider1">
											...
											<ul class="slides">
												<li data-thumb="{{ url('images/usaha/' . $result->foto1) }}">
													<div class="thumb-image"> <img src="{{ url('images/usaha/' . $result->foto1) }}" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
												@if ($result->foto2 != '')
												<li data-thumb="{{ url('images/usaha/' . $result->foto2) }}">
													<div class="thumb-image"> <img src="{{ url('images/usaha/' . $result->foto2) }}" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
												@endif
												@if ($result->foto3 != '')
												<li data-thumb="{{ url('images/usaha/' . $result->foto3) }}">
													<div class="thumb-image"> <img src="{{ url('images/usaha/' . $result->foto3) }}" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
												@endif
                        ...
                        @endif
						@if (count($upload) > 0)
                        <a href="{{url('transaksi/status/edit/3')}}/{{$result->id_transaksi}}"><input type="button" onclick="return confirm('Apakah anda yakin ingin menyelesaikan pesanan?')" class="btn btn-warning" name="selesai" value="Transaksi Selesai"></a>
                        @endif
                        @endif
                        </form></td>
                        </tr>
						...
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto1) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto1) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto2) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto2) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto3) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto3) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto4) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto4) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto5) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto5) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto6) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto6) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto7) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto7) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto8) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto8) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto9) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto9) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
                    ...
                    <div class="col-md-3 product-men women_two">
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="{{ url('images/usaha/' . $result->foto10) }}" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('images/usaha/' . $result->foto10) }}" class="link-product-add-cart" download>DOWNLOAD</a>
										</div>
									</div>
								</div>
							</div>
