...
<body>
	...
	<div class="banner-top container-fluid" id="home">
		...
		<!--//banner -->
		<!--/shop-->
		<h4 style="text-align: center;">DAFTAR TRANSAKSI</h4>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                          	@if (!isset(explode('//Pesan Pembatalan: ', $transaksi_pelapak->deskripsi)[1]))
                          	<a class="btn btn-danger" href="{{url('/transaksi/pembatalan'.'/'.$transaksi_pelapak->id_transaksi)}}">BATAL</a>
                          	<a class="btn btn-primary" href="{{url ('transaksi/upload_file').'/'.$transaksi_pelapak->id_transaksi}}">Upload File</a>
                          	@endif
                      	</td>
                        </tr>
                        @endforeach
