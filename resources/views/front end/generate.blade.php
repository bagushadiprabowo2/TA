...
<body>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="pembayaran" id="exampleInputEmail1" readonly="" value="{{$topup->pembayaran}}">
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">Jumlah</label>
		<input type="text " class="form-control" name="jumlah" id="exampleInputEmail1" readonly="" value="{{$topup->jumlah}}">
	</div>
	<input type="hidden" class="form-control" name="kode" readonly="" value="{{ session()->get('nama') }}">
	{{csrf_field()}}
	<a href="{{url('/transaksi/kode/generate/') .'/'. $topup->id}}" class="btn btn-primary">GET KODE GENERATE</a>
@endif
