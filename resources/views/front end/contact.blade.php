		...
		<div class="container-fluid">
			...
			<div class="inner-sec-shop px-lg-4 px-3">
				<div class="about-content py-lg-5 py-3">
					<div>
						<h3 class="title" style="text-align: center; font-size: 50px;">TENTANG BUKALENSA</h3><br><br><br> 
					</div>
					<div class="row">
						<div class="col-lg-6 p-0">
							<img src="images/BAN1.jpeg"class="img-fluid">
						</div>
						<div class="col-lg-6 about-info">
							<h3 class="tittle-w3layouts text-left mb-lg-5 mb-3">BUKALENSA</h3>
							<p class="my-xl-4 my-lg-3 my-md-4 my-3">BUKALENSA-- Adalah website yang menyediakan jasa untuk para pekerja seni grafis khusunya fotografi dan videografi untuk mepromosikan jasanya. Sering kali pekerja seni grafis kesusahan untuk mempromosikan jasanya agar laku dan banyak yang tahu, maka kami punya ide untuk membuat website yang berfungsi untuk mempermudah mempromosikan jasa fotografi dan videografi agar banyak yang tahu dan mempermudah para customer untuk mencari jasa foto dan video di sekitar wilayah yang mereka ingin kunjungi.
							</p>
						</div>
					</div>
				</div>
				<h3 class="tittle-w3layouts text-center my-lg-4 my-4">PEMBUAT</h3>
				<div class="partners-info">
					<div class="row mt-lg-5 mt-3">
					 <div class="col-md-6 team-main-gd">
							<div class="team-grid text-center">
								<div>
									<img class="img-fluid rounded" src="images/GAMBAR3.jpg" alt="">
								</div>
							</div>
						</div>
						<div class="col-md-6 team-main-gd">
							<div class="team-grid text-center">
								<div>
									<img class="img-fluid rounded" src="images/GAMBAR2.jpg" alt="">
								</div>
							</div>
						</div>
					</div>
