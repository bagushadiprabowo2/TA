            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="{{url ('usaha/update_usaha_pelapak')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{ method_field('post') }}
                    <p class="card-description">
                      ...
                      <input type="hidden" name="id_usaha" value="{{ $p->id_usaha }}">
                        ...
                        <input type="hidden" name="id_pelapak" value="{{ $p->id_pelapak }}">    
                    <div class="row">
                      <div class="col-md-6">
