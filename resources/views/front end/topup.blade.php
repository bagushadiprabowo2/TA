...
<body>
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light top-header mb-2">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-mega mx-auto">
						...
						@if(session()->get('level')==2)
						<a class="dropdown-item" href="{{url ('transaksi/riwayat_transaksi_pelapak')}}" style="text-transform: none;">Riwayat Transaksi</a>
						@endif
						@if(session()->get('level')==3)
						<a class="dropdown-item" href="{{url ('transaksi/riwayat_transaksi')}}" style="text-transform: none;">Riwayat Transaksi</a>
						@endif
						@if (session()->get('level') == 2)
						<li class="nav-item">
	...
	<script>
		$(function () {
			@if (session()->get('error')=== "insufficient")
			$.notify({
