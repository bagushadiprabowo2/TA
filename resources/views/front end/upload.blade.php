		...
		<div class="row">
			<div class="col-md-12 grid-margin">
				<div class="d-flex justify-content-between align-items-center">
					<div>
						<h4 class="font-weight-bold mb-0" style="padding-left: 710px;">UPLOAD FILE HUNTING</h4>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group row">
					...
					<form action="{{url('transaksi/upload_file')}}" method="post" enctype="multipart/form-data" style="padding-left: 700px; >
						<div class="col-sm-9">
							<input type="hidden" name="id_usaha" value="{{$id_usaha}}">
							<input type="hidden" name="id_pelanggan" value="{{$id_pelanggan}}">
							<input type="hidden" name="id_transaksi" value="{{$id_transaksi}}">
							<input type="file" class="form-control" onchange="return cekfoto('foto1','foto2')" id="foto1" name="foto1">
							<input type="file" class="form-control" onchange="return cekfoto('foto2','foto3')" id="foto2" hidden name="foto2">
							<input type="file" class="form-control" onchange="return cekfoto('foto3','foto4')" id="foto3" hidden name="foto3">
							<input type="file" class="form-control" onchange="return cekfoto('foto4','foto5')" id="foto4" hidden name="foto4">
							<input type="file" class="form-control" onchange="return cekfoto('foto5','foto6')" id="foto5" hidden name="foto5">
							<input type="file" class="form-control" onchange="return cekfoto('foto6','foto7')" id="foto6" hidden name="foto6">
							<input type="file" class="form-control" onchange="return cekfoto('foto7','foto8')" id="foto7" hidden name="foto7">
							<input type="file" class="form-control" onchange="return cekfoto('foto8','foto9')" id="foto8" hidden name="foto8">
							<input type="file" class="form-control" onchange="return cekfoto('foto9','foto10')" id="foto9" hidden name="foto9">
							<input type="file" class="form-control"  id="foto10" hidden name="foto10">
						</div>
						{{csrf_field()}}
						<button style="margin-left: 780px;" type="submit" class="btn btn-primary">UPLOAD</button>
						<br>
						<br>
						<br>
						<br>
