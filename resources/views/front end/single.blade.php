...
<body>
	<div class="banner-top container-fluid" id="home">
					...
					<div class="row">
							<div class="col-lg-4 single-right-left ">
								...
								<div class="col-lg-8 single-right-left simpleCart_shelfItem">
									<h3>{{$b->nama_usaha}}</h3>
									<h4><p class="fa fa-home" style="font-size: 15px;">{{ $b->kota}}</p></h4>
									@foreach($usaha as $result)
									<input type="text" class="ratingEvent rating5" name="rating" readonly value="{{ $result->rating}}">
									...
									@endforeach
										...
										<div class="colr" style="margin: 1px; padding: 6px; width: 33%;">
											<label class="radio">
												<i></i>
												"{{ $p->nama_paket }}"
												<p style="margin: 0; line-height: 1em; font-size: 1em;">{{'Rp.'.number_format($p->harga,2) }}</p>
												<br>
									...
									@if (session()->get('level') == 3)
									<button type="button"><a href="{{url('transaksi/tambah') . '/'.$b->id_usaha}}" class="btn btn-primary">PESAN JASA
									</a></button>
									@endif  									
								</div>
								<div class="clearfix"> </div>
									...
									<div class="tab2">
												...
												<div class="single_page" style="width: 100%;">
													...
													<form class="form-horizontal">
														...
														<div class="control-group">
															<input type="text" class="ratingEvent rating5" name="rating" readonly value="{{ $h->rating}}">
															
																<span class="control-label" style="font-weight: bold;">{{$h->id_pengguna}} </span>
															<div class="controls form-inline" style="width: 800px;">
																<textarea class="table table-striped table-bordered bootstrap-datatable datatable" readonly style="width: 800px;">{{$h->komen}}</textarea>
																<br>
															</div>
														</div>
													</form>
		...
		$(function () {
			...
			$.notify({
				message: "Anda Sudah Punya Pesanan, Mohon Selesaikan Terlebih Dahulu",
			}, {
				type: 'danger',
				timer: 4000,
			});
