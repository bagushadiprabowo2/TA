...
<body>
	<div class="banner-top container-fluid" id="home">
        ...
        <form class="form-sample" action="{{url('transaksi/store')}}" method="post">
     <div class="form-group">
      <label for="exampleInputEmail1">Nama Pelanggan</label>
      <input type="text" class="form-control" name="id_pelanggan" id="Fullname" readonly="" value="{{ session()->get('nama') }}">
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Nama Lapak</label>
      <input type="hidden" name="id_pelapak" value="{{ $b->id_pelapak }}">
      <input type="text" class="form-control" id="username" name="id_usaha" readonly="" value="{{ $b->nama_usaha }}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <select data-placeholder="pilih pengguna" name="pilih_paket" id="pilih_paket" class="form-control" onchange="sethargapaket(this)">
      <option value=""> pilih paket </option>
      @foreach($paket as $p)
      <option value="{{$p->id}}">{{$p->nama_paket}} - {{$p->harga}}</option>
      @endforeach
       </select>
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Harga</label>
      <input type="text" class="form-control" id="harga_paket" name="harga" placeholder="Harga" readonly="">
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Deskripsi</label>
      <textarea class="form-control" id="harga_paket" name="deskripsi" placeholder="Pesan tanbahan"></textarea>
    </div>
    {{csrf_field()}}
