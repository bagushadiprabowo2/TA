...
<body>
	<div class="banner-top container-fluid" id="home">
        ...
        <form class="form-sample" action="{{url('transaksi/store_pembatalan')}}" method="post">
      		
    	<div class="form-group">
      		<label for="exampleInputEmail1">Deskripsi</label>
      			<input type="hidden" name="id_trx" value="{{$b->id_transaksi}}">
      			<input type="hidden" name="old_deskripsi" value="{{$b->deskripsi}}">
      			<input type="hidden" name="id_plapak" value="{{$b->id_pelapak}}">
      			<textarea class="form-control" name="deskripsi" placeholder="Pesan tanbahan"></textarea>
    	</div>
    {{csrf_field()}}
