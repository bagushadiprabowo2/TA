...
<body>
	<div class="banner-top container-fluid" id="home">
		...
		<div class="col-md-4">
		@foreach ($usaha as $b)
        <form class="form-sample" action="{{url('usaha/store_paket_pelapak')}}" method="post">
     <div class="form-group">
      <input type="text" class="form-control" name="id_usaha" id="Fullname" hidden="" readonly="" value="{{$b->id_usaha}}">
    </div>
    <div class="form-group">
    ...
    {{csrf_field()}}
    <div class="text-center"> <button type="submit" class="btn btn-primary ">TAMBAH</button></div>
  </form>
</div>
		<div class="col-md-4"></div>
	</div>
